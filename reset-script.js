...
// Configuration - UPDATE THESE URLs TO YOUR HOSTED WEBSITES
const MAIN_WEBSITE_URL = "https://yourmainwebsite.com"; // Replace with your main website URL
const RESET_WEBSITE_URL = "https://yourresetwebsite.com"; // Replace with your reset password website URL
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (type === "recovery" && accessToken) {
    ...
    const altAccessToken =
      urlSearchParams.get("access_token") || urlSearchParams.get("token");
    ...
    if (altType === "recovery" && altAccessToken) {
      ...
      showError(
        "Invalid Reset Link",
        "This password reset link is invalid or malformed. Please request a new password reset."
      );
    }
  }
  ...
  if (confirmPassword) {
    if (newPassword === confirmPassword) {
      ...
      passwordMatch.innerHTML =
        '<i class="fas fa-times"></i> Passwords don\'t match';
